...
It is a partially functional demo e-commerce website featuring user authentication, a shopping cart system, and dynamic product pages. This project demonstrates full-stack development using **Python, Flask, Jinja2 templating, and custom CSS**, with a focus on clean UI, usability, and maintainable backend code.
